...
class DueInvoiceDataTable extends DataTable
{
    /**
    ...
    public function query(Invoice $model)
    {
        ...
        return $model->select()
            ...
            ->where([['due_date', '<', $today], ['payment_status', '=', 'pending']])
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('vendor_id')->title('Technician'),
            Column::make('due_date')->title('Invoice Due Date'),
    ...
    {
        return 'DueInvoice_' . date('YmdHis');
    }
}
