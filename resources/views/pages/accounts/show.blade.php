                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('account.index') }}"
                                            class="breadcrumb-link">Invoices</a></li>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <form style="display: inline-block;" method="post"
                                action="{{route('account.destroy', $invoice->id)}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <p>{{$invoice->customer->name}} | Technician: {{ $invoice->technician->name }}
                                        </p>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Last Service Cost</label>
                                                <p>{{ isset($last_serviced_cost->grand_total )? presentPrice($last_serviced_cost->grand_total) : presentPrice(0) }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-total text-right">
                                            {{ presentPrice($service->quantity * $service->price) }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-amount text-right">{{ presentPrice($invoice->grand_total) }}
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
