                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Newly Converted Prospects</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{ route('app.dashboard') }}" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">All New Customers</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
...
@section('scripts')
    ...
    $(document).ready(function() {
        $('#basic-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! route('customer.newly.converted') !!}',
            columns: [
                ...
                { data: 'customer_type_id', name: 'customerType.name' },
